...
Data = xlsread('TensorDB_CijONLY.xlsx');
Tensors = Data(:,1:21);
...
dlmwrite('BreakdownTest.txt',Breakdown,'delimiter','\t','precision',10)
%dlmwrite('SymmetryView.txt',SymmetryAxis,'\t');
%dlmwrite('IsotropicComponents.txt',IsoComponent,'\t');
%dlmwrite('HexagonalComponents.txt',IsoComponent+HexagonalComponent,'\t');
